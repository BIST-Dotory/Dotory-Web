      ...
      <div class="detail">
        <div class="form-container">
          <div class="form-group">
            ...
            <input id="room" type="text" v-model="formData.id" readonly />
          </div>
        ...
        <div class="button-container">
          ...
          <div class="button-container-right">
            <button class="btn-rewrite" @click="showDialog = true">
        ...
        <div class="dialog-overlay" v-if="showDialog">
            <div class="dialog-box">
              <h3 class="dialog-title">회원정보를 저장하겠습니까?</h3>
              <p class="dialog-message">이전 회원정보는 복구되지 않습니다.</p>
