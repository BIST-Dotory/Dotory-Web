...
export default {
  data() {
    return {
      items: [
        { id: 1, title: '첫번째 건의사항', author: '사용자', date: '2024.11.27', views: 10 },
        { id: 2, title: '두번째 건의사항', author: '가나다', date: '2024.11.27', views: 8 },
        { id: 3, title: '세번째 건의사항', author: '라마바', date: '2024.11.29', views: 5 },
        { id: 4, title: '네번째 건의사항', author: '도레미', date: '2024.11.30', views: 7 },
        { id: 5, title: '다섯번째 건의사항', author: '알파벳', date: '2024.12.01', views: 1 },
      ],
      itemsPerPage: 10,
      currentPage: 1,
      maxVisiblePages: 5,
