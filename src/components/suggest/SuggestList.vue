  ...
  data() {
    return {
      items: [
        ...
        { id: 7, title: '일곱번째 건의사항', author: '사용자', date: '2024.11.19', views: 0 },
        { id: 8, title: '여덞번째 건의사항', author: '사용자', date: '2024.11.20', views: 5 },
        { id: 9, title: '아홉번째 건의사항', author: '사용자', date: '2024.11.21', views: 10 },
        { id: 10, title: '열번째 건의사항', author: '사용자', date: '2024.11.22', views: 7 },
      ],
      itemsPerPage: 3,
      currentPage: 1,
      maxVisiblePages: 5,
