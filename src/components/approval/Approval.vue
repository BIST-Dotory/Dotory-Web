<template>
  <div class="container">
    ...
    <div class="content">
      <table class="board-table">
        ...
        <tbody>
          <tr v-for="(item, index) in paginatedItems" :key="item.id">
            ...
            <td>{{ item.tel }}</td>
            <td>
              <button class="btn-delete" @click="showDialogAccept = true">승인</button>&nbsp;
              <button class="btn-delete" @click="showDialogReject = true">거절</button>
            </td>
          </tr>
      ...
      <div class="dialog-overlay" v-if="showDialogAccept">
        <div class="dialog-box">
          <h3 class="dialog-title">가입승인 처리하겠습니까?</h3>
          <p class="dialog-message">승인한 회원정보는 "학생정보" 에서 확일할 수 있습니다.</p>
          <div class="dialog-buttons">
            <button class="dialog-btn" @click="goBack">승인</button>
            <button class="dialog-btn-cancel" @click="showDialogAccept = false">취소</button>
          </div>
        </div>
      </div>
      <div class="dialog-overlay" v-if="showDialogReject">
        <div class="dialog-box">
          <h3 class="dialog-title">가입거절 처리하겠습니까?</h3>
          <p class="dialog-message">거절한 회원정보는 복구되지 않습니다.</p>
          <div class="dialog-buttons">
            <button class="dialog-btn" @click="goBack">거절</button>
            <button class="dialog-btn-cancel" @click="showDialogReject = false">취소</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      items: [
        { id: 6, room: '105', number: '20000005', name: '일이삼', major: '수학과', tel: '010-0000-0005' },
        { id: 7, room: '106', number: '20000006', name: '도자기', major: '조형학과', tel: '010-0000-0006' },
      ],
      itemsPerPage: 3,
      currentPage: 1,
      maxVisiblePages: 5,
