...
export default {
  data() {
    return {
      items: [
        { id: 1, title: '첫번째 공지사항', author: '관리자', date: '2024.11.19', views: 100 },
        { id: 2, title: '두번째 공지사항', author: '관리자', date: '2024.11.20', views: 90 },
        { id: 3, title: '세번째 공지사항', author: '관리자', date: '2024.11.21', views: 90 },
        { id: 4, title: '네번째 공지사항', author: '관리자', date: '2024.11.22', views: 80 },
        { id: 5, title: '다섯번째 공지사항', author: '관리자', date: '2024.11.23', views: 80 },
        { id: 6, title: '여섯번째 공지사항', author: '관리자', date: '2024.11.23', views: 70 },
        { id: 7, title: '일곱번째 공지사항', author: '관리자', date: '2024.11.23', views: 70 },
        { id: 8, title: '여덞번째 공지사항', author: '관리자', date: '2024.11.24', views: 60 },
        { id: 9, title: '아홉번째 공지사항', author: '관리자', date: '2024.11.25', views: 60 },
        { id: 10, title: '열번째 공지사항', author: '관리자', date: '2024.11.26', views: 50 },
        { id: 11, title: '열한번째 공지사항', author: '관리자', date: '2024.11.27', views: 50 },
        { id: 12, title: '열두번째 공지사항', author: '관리자', date: '2024.11.28', views: 40 },
        { id: 13, title: '열세번째 공지사항', author: '관리자', date: '2024.11.29', views: 30 },
        { id: 14, title: '열네번째 공지사항', author: '관리자', date: '2024.11.30', views: 20 },
        { id: 15, title: '열다섯번째 공지사항', author: '관리자', date: '2024.12.01', views: 10 },
      ],
      itemsPerPage: 10,
      currentPage: 1,
      maxVisiblePages: 5,
