  ...
  data() {
    return {
      ...
      items: [
        ...
        { id: 2, room: '101', number: '20000001', name: '가나다', major: '국어국문학과', tel: '010-0000-0001'},
        { id: 3, room: '102', number: '20000002', name: '도레미', major: '실용음악과', tel: '010-0000-0002'},
        { id: 4, room: '103', number: '20000003', name: '알파벳', major: '영어영문학과', tel: '010-0000-0003'},
      ],
      itemsPerPage: 3,
      currentPage: 1,
      maxVisiblePages: 5,
