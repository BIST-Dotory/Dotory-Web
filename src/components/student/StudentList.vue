  ...
  data() {
    return {
      ...
      items: [
        ...
        { id: 2, room: '101', number: '20000000', name: '가나다', major: '국어국문학과', tel: '010-0000-0000'},
        { id: 3, room: '101', number: '20000000', name: '도레미', major: '실용음악과', tel: '010-0000-0000'},
        { id: 4, room: '101', number: '20000000', name: '알파벳', major: '영어영문학과', tel: '010-0000-0000'},
      ],
      itemsPerPage: 3,
      currentPage: 1,
      maxVisiblePages: 5,
